...
def Kermanshahtemp(data):
    if data == "kermanshah":
        URL = "https://api.open-meteo.com/v1/forecast?latitude=34.3142&longitude=47.065&hourly=temperature_2m"
        location = "delhi technologicaluniversity"
        PARAM = {"adress": location}
        info = requests.get(url=URL, params=PARAM)
        data = info.json()
        temps = data["hourly"]["temperature_2m"]
        return f"""<b>وضعیت دما در شهر کرمانشاه:</b>
